...
Source0  : https://files.pythonhosted.org/packages/e3/0f/d40bbe294bbf004d436a8bcbcfaadca8b5140d39ad0ad3d73d1a8ba15f14/automat-25.4.16.tar.gz
...
%prep
%setup -q -n automat-25.4.16
cd %{_builddir}/automat-25.4.16
pushd ..
cp -a automat-25.4.16 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1744898275
